...
export default function WasherApplicationPage() {
        ...
        return (
            <div className="container mx-auto max-w-4xl py-10">
                <Alert variant="destructive">
                    ...
                    <AlertDescription>We couldn't find a profile for your account. Please contact support.</AlertDescription>
                </Alert>
            </div>
        )
    }
    ...
    if (profile.role !== 'washer' || (profile.washer_status && profile.washer_status !== 'pending_application')) {
         return (
            <div className="container mx-auto max-w-4xl py-10">
                 <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Your application is currently being reviewed, or has already been processed.
    ...
    if (profile.role === 'washer' && profile.washer_status === 'pending_application') {
        return (
            <div className="container mx-auto max-w-4xl py-10">
                <div className="mb-4">
                    <Link href="/dashboard" className="text-sm flex items-center text-gray-600 hover:text-gray-900">
