...
export default function WasherReferralsPage() {
  ...
  const userReferrals = referralEvents.filter(
    (e) => e.profiles?.role === 'user' || !e.profiles?.role
  )
  const washerReferrals = referralEvents.filter(
    (e) => e.profiles?.role === 'washer'
  )
  const approvedWashers = washerReferrals.filter(
    (e) => e.profiles?.washer_status === 'approved'
  )

  const userRewardsEarned =
    userReferrals.filter((e) => e.status === 'reward_issued').length * 5
  const washerRewardsEarned = approvedWashers.length * 15 // £15 per approved washer
    ...
    <div className='space-y-8'>
      ...
      <div>
        ...
        <p className='text-muted-foreground'>
          Grow our community and earn enhanced rewards by referring both users
          and washers.
        </p>
      </div>
          ...
          <div className='flex items-center space-x-3'>
            ...
            <div>
              <CardTitle className='text-2xl'>
                Enhanced Washer Rewards
              </CardTitle>
              <CardDescription>
                As a trusted washer, you earn more for quality referrals that
                grow our platform.
              </CardDescription>
            </div>
          </div>
        ...
        <CardContent>
          <div className='mb-4 grid gap-4 md:grid-cols-2'>
            ...
            <div className='rounded-lg bg-white/50 p-4'>
              ...
              <p className='text-sm text-gray-600'>
                £15 reward when they get approved and complete their first
                booking
              </p>
            </div>
          </div>
            ...
            <div className='ml-4 space-y-3'>
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-muted-foreground text-sm'>
                    Share with friends, family, or neighbors who need laundry
                    services.
                  </p>
                </div>
              </div>
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-muted-foreground text-sm'>
                    They get 50% off their first wash, expanding our customer
                    base.
                  </p>
                </div>
              </div>
            ...
            <div className='ml-4 space-y-3'>
              ...
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-muted-foreground text-sm'>
                    They complete the washer application and verification
                    process.
                  </p>
                </div>
              </div>
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  <p className='font-medium'>You Earn £15</p>
                  <p className='text-muted-foreground text-sm'>
              ...
              <tbody className='bg-background divide-y'>
                {referralEvents.length > 0 ? (
                  referralEvents.map((event) => {
                    ...
                    const rewardAmount = isWasher ? 15 : 5
                      ...
                      <tr key={event.id}>
                        ...
                        <td className='px-6 py-4 text-sm whitespace-nowrap'>
                          <Badge
                            ...
                            className={
                              isWasher ? 'bg-purple-100 text-purple-800' : ''
                            }
                          >
                            {isWasher ? (
                              <>
                        ...
                        <td className='px-6 py-4 text-sm whitespace-nowrap'>
                          ...
                          >
                            {isWasher
                              ? event.profiles?.washer_status?.replace(
                                  /_/g,
                                  ' '
                                ) || 'Pending'
                        ...
                        <td className='px-6 py-4 text-sm whitespace-nowrap'>
                          <span
                            className={`font-semibold ${hasEarnedReward ? 'text-green-600' : 'text-gray-400'}`}
                          >
                            £{rewardAmount}
                            {hasEarnedReward && (
      ...
      <Card className='border-green-200 bg-green-50 text-center'>
        <CardHeader>
          ...
          <CardTitle className='mt-4 text-green-800'>
            Growing Our Community Together
          </CardTitle>
          <CardDescription className='text-green-600'>
            Thank you for helping expand Neighbourhood Wash. Your referrals help
